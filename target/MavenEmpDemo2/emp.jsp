...
<body>
<!-- 员工展示 -->
<p id="p" style="display: none;" align="center">员工列表</p>
<hr>

 <div style="padding: 0px 200px; border-bottom-color:aqua;	text-align: center;"  class="easyui-panel" id="box">

<table align="center"  id="dg"></table>
<input type="button" id="tianjia" value="添加员工" >
</div>
...
<form action="" id="ffemp" name="ffemp" method="post" enctype="multipart/form-data">
 ...
 <tr align="center" bgcolor="#FFFFCC">
    <td colspan="3">
       ...
       <input type="button" style="display: none;" id="btupdate" value="修改">
